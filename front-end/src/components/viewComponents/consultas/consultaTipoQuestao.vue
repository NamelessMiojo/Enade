    ...
    <main class="corpo">
        <section class="principal">
            <section class="filtros">
                <form @submit.prevent="filterListTipoQuestao">
                    <div class="campo">
            ...
            <section class="resultados">
                <div v-for="qTipo in filterTipoQuestoes" :key="qTipo.id">
                    {{ qTipo.nome }}
                    <button @click="editarTipoQuestao">Editar</button>
                    <button @click="deleteTipoQuestao(qTipo.id)">Deletar</button>
                </div>
            </section>
        </section>
        ...
        <section class="detalhes">
            <section>
                <form ref="form" @submit.prevent="atualizarTipoQuestao">
...
export default {
    data(){
        return{
            ...
            id:'',
            nome:'',
            url:'http://localhost:56918/tipoQuestao/',
            filtro:'',
        }
    },
    methods: {
        ...
        filterListTipoQuestao(){
            ...
            .then(response => this.filterTipoQuestoes = (response.data.contents))
        },
        deleteTipoQuestao(tipoId){
            Swal.fire({
